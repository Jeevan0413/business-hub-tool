  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-slate-50 dark:bg-onyx-950 flex flex-col">
      ...
      <main className="flex-1 min-w-0 relative z-10">
        <div className="max-w-[1600px] mx-auto p-4 sm:p-6 lg:p-10 xl:p-12 animate-in">
          {children}
        </div>
      </main>

      {/* Subtle Footer for Top-Nav Layout */}
      <footer className="relative z-10 py-6 sm:py-8 px-4 sm:px-8 border-t border-slate-200/50 dark:border-white/5">
        <div className="max-w-[1600px] mx-auto flex flex-col md:flex-row justify-between items-center gap-4 text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">
